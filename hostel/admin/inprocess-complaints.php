            ...
            <div class="content-wrapper">
                ...
                <div class="card-panel">
                    <div class="card-header" style="border-bottom: 2px solid #f0f2f5; padding-bottom: 15px;">
                        <div class="card-title" style="font-size: 1.1rem; font-weight: 700; color: #2d3748;">All In Process Complaints Details</div>
                    </div>
                            ...
                            <table id="complaints-table" class="table table-modern" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge" style="background-color:rgba(246, 194, 62, 0.15); color:#d9a300; font-size:0.85em; padding:6px 12px; border-radius:20px; font-weight:600;"><i class="fas fa-clock me-1"></i> In Process</span>
                                        </td>
